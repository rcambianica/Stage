...
public class Costants {
    ...
    public static final String DISPLAY_PULSE_OXIMETER = "Pulse Oximeter";
    public static final String DISPLAY_WEIGHT_SCALE = "Weight Scale";
    public static final String DISPLAY_ECG = "Ecg";
}
